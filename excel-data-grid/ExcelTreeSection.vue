      ...
      <div class="excel-tree-layout">
        <div class="excel-grid-card excel-grid-card--tree">
          ...
          <div class="excel-table-status">
            <span>{{ visibleTreeCount }} visible of {{ treeNodes.length }} nodes</span
            ><span>TreeDataPlugin reads parent references from your model</span>
          </div>
        </div>
...
const treeNodes = [
  {
    id: 'atlas',
    parentId: null,
    label: 'Atlas platform migration',
    owner: 'H. Ibarra',
    effort: '1,240h',
    progress: 62,
    due: '2027-02-28',
...
const treeColumns = [
  ...
  { name: 'Assignee', prop: 'owner', size: 130, readonly: true },
  {
    ...
    size: 105,
    readonly: true,
    dataGridFormat: excelMonoRightFormat,
  },
  {
    name: 'Progress',
    prop: 'progress',
    size: 140,
    readonly: true,
    dataGridFormat: excelProgressFormat,
  },
