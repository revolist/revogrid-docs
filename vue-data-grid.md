...
faq:
  ...
  items:
    ...
    - q: Which frameworks can share the same RevoGrid foundation?
      a: RevoGrid supports Vue, React, Angular, Svelte, JavaScript, and TypeScript-oriented projects, so teams can keep one grid model across multiple front-end stacks.
