...
| `colData` _(required)_           | --                | Column source                                                                                                                                                                              | `"colPinEnd" \| "colPinStart" \| "rgCol" \| ColumnRegular`                                                                                                                                      | `undefined` |
| `colType` _(required)_           | `col-type`        | Column data type                                                                                                                                                                           | `"colPinEnd" \| "colPinStart" \| "rgCol" \| "rowHeaders"`                                                                                                                                       | `undefined` |
| `dataStore` _(required)_         | --                | Data rows source                                                                                                                                                                           | `"rgRow" \| "rowPinEnd" \| "rowPinStart" \| D`                                                                                                                                                  | `undefined` |
