...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `afterpasteapply`  | Paste 4. Fired after paste applied to the grid defaultPrevented - if true, paste will be canceled                         | `CustomEvent<{ raw: string; parsed: string[][]; dataText: string; event: ClipboardEvent; }>` |
...
| `beforepasteapply` | Paste 2. Fired before paste applied to the grid and after data parsed                                                     | `CustomEvent<{ raw: string; parsed: string[][]; dataText: string; event: ClipboardEvent; }>` |
