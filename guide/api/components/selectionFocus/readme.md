...
| `selectionStore` _(required)_ | --         | Selection, range, focus for selection                                     | `{ range: RangeArea \| null; tempRange: RangeArea \| null; tempRangeType: string \| null; focus: Cell \| null; edit: EditCellStore \| null; lastCell: Cell \| null; nextFocus: Cell \| null; }` | `undefined` |
