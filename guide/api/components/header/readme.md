...
| `beforegroupheaderrender` | Before each group header cell render function. Allows to override group header cell properties | `CustomEvent<{ start: number; end: number; group: Group; providers: Providers<DimensionCols \| "rowHeaders">; additionalData: any; canResize?: boolean \| undefined; onResize?(e: ResizeEvent): void; } & Partial<Pick<ResizeProps, "active">>>`                                                                                                                          |
