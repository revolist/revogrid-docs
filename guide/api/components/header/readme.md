...
| `colData`           | --                | Columns - defines an array of grid columns.                                                     | `ColumnRegular<ColumnProp>[]`                                                                                                                                                                   | `undefined` |
...
| `beforeheaderclick`       | On initial header click                                                                        | `CustomEvent<{ index: number; originalEvent: MouseEvent; column: ColumnRegular<ColumnProp>; providers: ProvidersColumns<DimensionCols \| "rowHeaders">; }>`                                                                                                                                                                                                                           |
...
| `beforeheaderresize`      | On before header resize                                                                        | `CustomEvent<ColumnRegular<ColumnProp>[]>`                                                                                                                                                                                                                                                                                                                                            |
| `headerdblclick`          | On header double click                                                                         | `CustomEvent<{ index: number; originalEvent: MouseEvent; column: ColumnRegular<ColumnProp>; providers: ProvidersColumns<DimensionCols \| "rowHeaders">; }>`                                                                                                                                                                                                                           |
