...
| `column`         | --                | Column data for editor.                                                | `null \| { prop: ColumnProp; model: DataType; column: ColumnRegular; rowIndex: number; colIndex: number; colType: DimensionCols; type: DimensionRows; data: DataType[]; value: any; }`                     | `undefined` |
