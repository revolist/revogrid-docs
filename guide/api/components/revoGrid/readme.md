...
| `columns`                    | --                              | Columns - defines an array of grid columns. Can be column or grouped column.                                                                                                                                                                                                                                    | `(ColumnRegular \| ColumnGrouping<any>)[]`                                                                                                                             | `[]`        |
...
| `beforecolumnsgather`      | Emitted before user column definitions are gathered into the internal column collection. Listeners can replace `detail.columns` to rewrite the raw column set before RevoGrid normalizes it.                                                                                                                    | `CustomEvent<{ columns: (ColumnRegular \| ColumnGrouping<any>)[]; }>`                                                                                                                                                       |
