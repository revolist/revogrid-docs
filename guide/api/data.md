...
| `beforecellrender` | Before each cell render function. Allows to override cell properties | `CustomEvent<BeforeCellRenderEvent<CellTemplateProp<DataType<any, ColumnProp>, ColumnRegular<ColumnProp>, ColumnProp>>>` |
...
| `dragstartcell`    | Event emitted on cell drag start                                     | `CustomEvent<DragStartEvent<DataType<any, ColumnProp>, ColumnRegular<ColumnProp>>>`                                      |
