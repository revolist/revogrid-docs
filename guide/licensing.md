...
Unlocks the most advanced features of RevoGrid, including Pivot Grid, Gantt Chart, AI, premium support, private GitHub repository access, totals, drill-down, field panels, custom aggregations, and server-side analytics contracts. It also includes everything offered in the Pro Light plan.
