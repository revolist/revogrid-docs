[RevoGrid Documentation v4.21.2](README.md) / RevogrHeaderCustomEvent
...
| `target` | `public` | `HTMLRevogrHeaderElement` | Returns the object to which event is dispatched (its target). [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/target) | `CustomEvent.target` | - | [src/components.d.ts:842](https://github.com/revolist/revogrid/blob/3af08818f9f1fedaed7deba00c15404a09ccf4a6/src/components.d.ts#L842) |
