[RevoGrid Documentation v4.23.3](README.md) / RevogrClipboardCustomEvent
...
| `target` | `public` | `HTMLRevogrClipboardElement` | Returns the object to which event is dispatched (its target). [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/target) | `CustomEvent.target` | - | [src/components.d.ts:822](https://github.com/revolist/revogrid/blob/70bb45efb434905fefaf72f1148974b6ef74baa4/src/components.d.ts#L822) |
