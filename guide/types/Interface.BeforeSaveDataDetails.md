[RevoGrid Documentation v4.15.5](README.md) / BeforeSaveDataDetails
...
| `val?` | `any` | Value from editor to save, not part of the model value yet | - | [src/types/selection.ts:123](https://github.com/revolist/revogrid/blob/e4de5901d3a858ae9e9a420f27ffcd2a33073a79/src/types/selection.ts#L123) |
