[RevoGrid Documentation v4.23.23](README.md) / VnodeHtmlCustomEvent
...
| `detail` | `public` | `T` | Returns any custom data event was created with. Typically used for synthetic events. [MDN Reference](https://developer.mozilla.org/docs/Web/API/CustomEvent/detail) | `CustomEvent.detail` | - | [src/components.d.ts:870](https://github.com/revolist/revogrid/blob/d86bc879402becda10cf23ab9a60c0932f7589d3/src/components.d.ts#L870) |
...
| `target` | `public` | `HTMLVnodeHtmlElement` | Returns the object to which event is dispatched (its target). [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/target) | `CustomEvent.target` | - | [src/components.d.ts:871](https://github.com/revolist/revogrid/blob/d86bc879402becda10cf23ab9a60c0932f7589d3/src/components.d.ts#L871) |
