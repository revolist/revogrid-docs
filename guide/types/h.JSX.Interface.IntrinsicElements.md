[@revolist/revogrid](README.md) / [h](Namespace.h.md) / [JSX](h.Namespace.JSX.md) / IntrinsicElements
...
| ------ | ------ | ------ | ------ | ------ |
| `a` | `AnchorHTMLAttributes`\<`HTMLAnchorElement`\> | - | `JSXBase.IntrinsicElements.a` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:591 |
| `abbr` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.abbr` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:592 |
| `address` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.address` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:593 |
| `animate` | `SVGAttributes`\<`SVGElement`\> | - | `JSXBase.IntrinsicElements.animate` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:704 |
| `area` | `AreaHTMLAttributes`\<`HTMLAreaElement`\> | - | `JSXBase.IntrinsicElements.area` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:594 |
| `article` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.article` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:595 |
| `aside` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.aside` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:596 |
| `audio` | `AudioHTMLAttributes`\<`HTMLAudioElement`\> | - | `JSXBase.IntrinsicElements.audio` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:597 |
| `b` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.b` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:598 |
| `base` | `BaseHTMLAttributes`\<`HTMLBaseElement`\> | - | `JSXBase.IntrinsicElements.base` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:599 |
| `bdi` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.bdi` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:600 |
| `bdo` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.bdo` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:601 |
| `big` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.big` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:602 |
| `blockquote` | `BlockquoteHTMLAttributes`\<`HTMLQuoteElement`\> | - | `JSXBase.IntrinsicElements.blockquote` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:603 |
| `body` | `HTMLAttributes`\<`HTMLBodyElement`\> | - | `JSXBase.IntrinsicElements.body` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:604 |
| `br` | `HTMLAttributes`\<`HTMLBRElement`\> | - | `JSXBase.IntrinsicElements.br` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:605 |
| `button` | `ButtonHTMLAttributes`\<`HTMLButtonElement`\> | - | `JSXBase.IntrinsicElements.button` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:606 |
| `canvas` | `CanvasHTMLAttributes`\<`HTMLCanvasElement`\> | - | `JSXBase.IntrinsicElements.canvas` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:607 |
| `caption` | `HTMLAttributes`\<`HTMLTableCaptionElement`\> | - | `JSXBase.IntrinsicElements.caption` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:608 |
| `circle` | `SVGAttributes`\<`SVGElement`\> | - | `JSXBase.IntrinsicElements.circle` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:705 |
| `cite` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.cite` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:609 |
| `clipPath` | `SVGAttributes`\<`SVGElement`\> | - | `JSXBase.IntrinsicElements.clipPath` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:706 |
| `code` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.code` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:610 |
| `col` | `ColHTMLAttributes`\<`HTMLTableColElement`\> | - | `JSXBase.IntrinsicElements.col` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:611 |
| `colgroup` | `ColgroupHTMLAttributes`\<`HTMLTableColElement`\> | - | `JSXBase.IntrinsicElements.colgroup` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:612 |
| `data` | `HTMLAttributes`\<`HTMLDataElement`\> | - | `JSXBase.IntrinsicElements.data` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:613 |
| `datalist` | `HTMLAttributes`\<`HTMLDataListElement`\> | - | `JSXBase.IntrinsicElements.datalist` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:614 |
...
| `feSpotLight` | `SVGAttributes`\<`SVGElement`\> | - | `JSXBase.IntrinsicElements.feSpotLight` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:732 |
...
| `main` | `HTMLAttributes`\<`HTMLElement`\> | - | `JSXBase.IntrinsicElements.main` | node\_modules/@stencil/core/internal/stencil-public-runtime.d.ts:652 |
...
| `revo-grid` | [`RevoGrid`](JSX.Interface.RevoGrid.md) & `HTMLAttributes`\<`HTMLRevoGridElement`\> | Revogrid - High-performance, customizable grid library for managing large datasets. :::tip Read [type definition file](https://github.com/revolist/revogrid/blob/master/src/interfaces.d.ts) for the full interface information. All complex property types such as `ColumnRegular`, `ColumnProp`, `ColumnDataSchemaModel` can be found there. ::: :::info For a comprehensive events guide, check the [Events](./events.md). All events propagate to the root level of the grid. [Dependency tree](#Dependencies). ::: **Examples** `data-rgCol-rgRow - main data slot. Applies extra elements in <revogr-data />.` `focus-rgCol-rgRow - focus layer for main data. Applies extra elements in <revogr-focus />.` | `LocalJSX.IntrinsicElements.revo-grid` | [src/components.d.ts:2329](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2329) |
| `revogr-attribution` | [`RevogrAttribution`](JSX.Interface.RevogrAttribution.md) & `HTMLAttributes`\<`HTMLRevogrAttributionElement`\> | - | `LocalJSX.IntrinsicElements.revogr-attribution` | [src/components.d.ts:2330](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2330) |
| `revogr-clipboard` | [`RevogrClipboard`](JSX.Interface.RevogrClipboard.md) & `HTMLAttributes`\<`HTMLRevogrClipboardElement`\> | This Clipboard provides functionality for handling clipboard events in a web application. | `LocalJSX.IntrinsicElements.revogr-clipboard` | [src/components.d.ts:2334](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2334) |
| `revogr-data` | [`RevogrData`](JSX.Interface.RevogrData.md) & `HTMLAttributes`\<`HTMLRevogrDataElement`\> | This component is responsible for rendering data Rows, columns, groups and cells | `LocalJSX.IntrinsicElements.revogr-data` | [src/components.d.ts:2339](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2339) |
| `revogr-edit` | [`RevogrEdit`](JSX.Interface.RevogrEdit.md) & `HTMLAttributes`\<`HTMLRevogrEditElement`\> | Represents a cell editor in a grid. It manages the editing of cells by handling events, saving data, rendering the editor UI, and managing the lifecycle of the editor instance. | `LocalJSX.IntrinsicElements.revogr-edit` | [src/components.d.ts:2345](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2345) |
| `revogr-extra` | [`RevogrExtra`](JSX.Interface.RevogrExtra.md) & `HTMLAttributes`\<`HTMLRevogrExtraElement`\> | Contains extra elements for stencil components. Performs rendering and updates for external components. **Example** `In Plugins if you want to add extra elements to grid and use stenciljs vnodes reactivity: function paginationPanel(this: PaginationPlugin, config: { refresh: () => void }) { // use `config.refresh()` for component to re-render return h('div') } revogrid.registerVNode = [ ...existingNodes, paginationPanel.bind(this) ]; /**` | `LocalJSX.IntrinsicElements.revogr-extra` | [src/components.d.ts:2360](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2360) |
| `revogr-filter-panel` | [`RevogrFilterPanel`](JSX.Interface.RevogrFilterPanel.md) & `HTMLAttributes`\<`HTMLRevogrFilterPanelElement`\> | - | `LocalJSX.IntrinsicElements.revogr-filter-panel` | [src/components.d.ts:2361](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2361) |
| `revogr-focus` | [`RevogrFocus`](JSX.Interface.RevogrFocus.md) & `HTMLAttributes`\<`HTMLRevogrFocusElement`\> | Focus component. Shows focus layer around the cell that is currently in focus. **Example** `focus-rgCol-rgRow` | `LocalJSX.IntrinsicElements.revogr-focus` | [src/components.d.ts:2366](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2366) |
| `revogr-header` | [`RevogrHeader`](JSX.Interface.RevogrHeader.md) & `HTMLAttributes`\<`HTMLRevogrHeaderElement`\> | - | `LocalJSX.IntrinsicElements.revogr-header` | [src/components.d.ts:2367](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2367) |
| `revogr-order-editor` | [`RevogrOrderEditor`](JSX.Interface.RevogrOrderEditor.md) & `HTMLAttributes`\<`HTMLRevogrOrderEditorElement`\> | Component for handling row order editor. | `LocalJSX.IntrinsicElements.revogr-order-editor` | [src/components.d.ts:2371](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2371) |
| `revogr-overlay-selection` | [`RevogrOverlaySelection`](JSX.Interface.RevogrOverlaySelection.md) & `HTMLAttributes`\<`HTMLRevogrOverlaySelectionElement`\> | Component for overlaying the grid with the selection. | `LocalJSX.IntrinsicElements.revogr-overlay-selection` | [src/components.d.ts:2375](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2375) |
| `revogr-row-headers` | [`RevogrRowHeaders`](JSX.Interface.RevogrRowHeaders.md) & `HTMLAttributes`\<`HTMLRevogrRowHeadersElement`\> | Row headers component Visible on the left side of the table | `LocalJSX.IntrinsicElements.revogr-row-headers` | [src/components.d.ts:2380](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2380) |
| `revogr-scroll-virtual` | [`RevogrScrollVirtual`](JSX.Interface.RevogrScrollVirtual.md) & `HTMLAttributes`\<`HTMLRevogrScrollVirtualElement`\> | Virtual scroll component | `LocalJSX.IntrinsicElements.revogr-scroll-virtual` | [src/components.d.ts:2384](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2384) |
| `revogr-temp-range` | [`RevogrTempRange`](JSX.Interface.RevogrTempRange.md) & `HTMLAttributes`\<`HTMLRevogrTempRangeElement`\> | Temporary range selection component. Shows temporary range selection. | `LocalJSX.IntrinsicElements.revogr-temp-range` | [src/components.d.ts:2388](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2388) |
| `revogr-viewport-scroll` | [`RevogrViewportScroll`](JSX.Interface.RevogrViewportScroll.md) & `HTMLAttributes`\<`HTMLRevogrViewportScrollElement`\> | Viewport scroll component for RevoGrid | `LocalJSX.IntrinsicElements.revogr-viewport-scroll` | [src/components.d.ts:2392](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2392) |
...
| `vnode-html` | [`VnodeHtml`](JSX.Interface.VnodeHtml.md) & `HTMLAttributes`\<`HTMLVnodeHtmlElement`\> | - | `LocalJSX.IntrinsicElements.vnode-html` | [src/components.d.ts:2393](https://github.com/revolist/revogrid/blob/ec98f5e49749ad8581a7f9ebef8e2f6167a106af/src/components.d.ts#L2393) |
