...
| `revo-grid` | [`RevoGrid`](JSX.Interface.RevoGrid.md) & `HTMLAttributes`\<`HTMLRevoGridElement`\> | Revogrid - High-performance, customizable grid library for managing large datasets. :::tip Read [type definition file](https://github.com/revolist/revogrid/blob/master/src/interfaces.d.ts) for the full interface information. All complex property types such as `ColumnRegular`, `ColumnProp`, `ColumnDataSchemaModel` can be found there. ::: :::info For a comprehensive events guide, check the [Events](./events.md). All events propagate to the root level of the grid. [Dependency tree](#Dependencies). ::: **Examples** `data-rgCol-rgRow - main data slot. Applies extra elements in <revogr-data />.` `focus-rgCol-rgRow - focus layer for main data. Applies extra elements in <revogr-focus />.` | `LocalJSX.IntrinsicElements.revo-grid` | [src/components.d.ts:2273](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2273) |
| `revogr-attribution` | [`RevogrAttribution`](JSX.Interface.RevogrAttribution.md) & `HTMLAttributes`\<`HTMLRevogrAttributionElement`\> | - | `LocalJSX.IntrinsicElements.revogr-attribution` | [src/components.d.ts:2274](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2274) |
| `revogr-clipboard` | [`RevogrClipboard`](JSX.Interface.RevogrClipboard.md) & `HTMLAttributes`\<`HTMLRevogrClipboardElement`\> | This Clipboard provides functionality for handling clipboard events in a web application. | `LocalJSX.IntrinsicElements.revogr-clipboard` | [src/components.d.ts:2278](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2278) |
| `revogr-data` | [`RevogrData`](JSX.Interface.RevogrData.md) & `HTMLAttributes`\<`HTMLRevogrDataElement`\> | This component is responsible for rendering data Rows, columns, groups and cells | `LocalJSX.IntrinsicElements.revogr-data` | [src/components.d.ts:2283](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2283) |
| `revogr-edit` | [`RevogrEdit`](JSX.Interface.RevogrEdit.md) & `HTMLAttributes`\<`HTMLRevogrEditElement`\> | Represents a cell editor in a grid. It manages the editing of cells by handling events, saving data, rendering the editor UI, and managing the lifecycle of the editor instance. | `LocalJSX.IntrinsicElements.revogr-edit` | [src/components.d.ts:2289](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2289) |
| `revogr-extra` | [`RevogrExtra`](JSX.Interface.RevogrExtra.md) & `HTMLAttributes`\<`HTMLRevogrExtraElement`\> | - | `LocalJSX.IntrinsicElements.revogr-extra` | [src/components.d.ts:2290](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2290) |
| `revogr-filter-panel` | [`RevogrFilterPanel`](JSX.Interface.RevogrFilterPanel.md) & `HTMLAttributes`\<`HTMLRevogrFilterPanelElement`\> | - | `LocalJSX.IntrinsicElements.revogr-filter-panel` | [src/components.d.ts:2291](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2291) |
| `revogr-focus` | [`RevogrFocus`](JSX.Interface.RevogrFocus.md) & `HTMLAttributes`\<`HTMLRevogrFocusElement`\> | Focus component. Shows focus layer around the cell that is currently in focus. **Example** `focus-rgCol-rgRow` | `LocalJSX.IntrinsicElements.revogr-focus` | [src/components.d.ts:2296](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2296) |
| `revogr-header` | [`RevogrHeader`](JSX.Interface.RevogrHeader.md) & `HTMLAttributes`\<`HTMLRevogrHeaderElement`\> | - | `LocalJSX.IntrinsicElements.revogr-header` | [src/components.d.ts:2297](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2297) |
| `revogr-order-editor` | [`RevogrOrderEditor`](JSX.Interface.RevogrOrderEditor.md) & `HTMLAttributes`\<`HTMLRevogrOrderEditorElement`\> | Component for handling row order editor. | `LocalJSX.IntrinsicElements.revogr-order-editor` | [src/components.d.ts:2301](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2301) |
| `revogr-overlay-selection` | [`RevogrOverlaySelection`](JSX.Interface.RevogrOverlaySelection.md) & `HTMLAttributes`\<`HTMLRevogrOverlaySelectionElement`\> | Component for overlaying the grid with the selection. | `LocalJSX.IntrinsicElements.revogr-overlay-selection` | [src/components.d.ts:2305](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2305) |
| `revogr-row-headers` | [`RevogrRowHeaders`](JSX.Interface.RevogrRowHeaders.md) & `HTMLAttributes`\<`HTMLRevogrRowHeadersElement`\> | Row headers component Visible on the left side of the table | `LocalJSX.IntrinsicElements.revogr-row-headers` | [src/components.d.ts:2310](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2310) |
| `revogr-scroll-virtual` | [`RevogrScrollVirtual`](JSX.Interface.RevogrScrollVirtual.md) & `HTMLAttributes`\<`HTMLRevogrScrollVirtualElement`\> | Virtual scroll component | `LocalJSX.IntrinsicElements.revogr-scroll-virtual` | [src/components.d.ts:2314](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2314) |
| `revogr-temp-range` | [`RevogrTempRange`](JSX.Interface.RevogrTempRange.md) & `HTMLAttributes`\<`HTMLRevogrTempRangeElement`\> | Temporary range selection component. Shows temporary range selection. | `LocalJSX.IntrinsicElements.revogr-temp-range` | [src/components.d.ts:2318](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2318) |
| `revogr-viewport-scroll` | [`RevogrViewportScroll`](JSX.Interface.RevogrViewportScroll.md) & `HTMLAttributes`\<`HTMLRevogrViewportScrollElement`\> | Viewport scroll component for RevoGrid | `LocalJSX.IntrinsicElements.revogr-viewport-scroll` | [src/components.d.ts:2322](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2322) |
...
| `vnode-html` | [`VnodeHtml`](JSX.Interface.VnodeHtml.md) & `HTMLAttributes`\<`HTMLVnodeHtmlElement`\> | - | `LocalJSX.IntrinsicElements.vnode-html` | [src/components.d.ts:2323](https://github.com/revolist/revogrid/blob/52c8861ed92574ba1d5817b32afec294ddb1f986/src/components.d.ts#L2323) |
