[RevoGrid Documentation v4.27.6](README.md) / RangeClipboardPasteEvent
...
| `data` | \{\} | - | - | [src/types/interfaces.ts:918](https://github.com/revolist/revogrid/blob/83088a5efb95df5d6b5a082ad10cadaa2bdcb42b/src/types/interfaces.ts#L918) |
| `models` | \{\} | - | - | [src/types/interfaces.ts:919](https://github.com/revolist/revogrid/blob/83088a5efb95df5d6b5a082ad10cadaa2bdcb42b/src/types/interfaces.ts#L919) |
| `range` | `null` \| [`RangeArea`](TypeAlias.RangeArea.md) | - | - | [src/types/interfaces.ts:920](https://github.com/revolist/revogrid/blob/83088a5efb95df5d6b5a082ad10cadaa2bdcb42b/src/types/interfaces.ts#L920) |
