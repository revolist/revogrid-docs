[RevoGrid Documentation v4.25.0](README.md) / RangeClipboardPasteEvent
...
| `data` | \{\} | - | - | [src/types/interfaces.ts:912](https://github.com/revolist/revogrid/blob/a6a858841b6179f71d79deffde996e3ef6220356/src/types/interfaces.ts#L912) |
| `models` | \{\} | - | - | [src/types/interfaces.ts:913](https://github.com/revolist/revogrid/blob/a6a858841b6179f71d79deffde996e3ef6220356/src/types/interfaces.ts#L913) |
| `range` | `null` \| [`RangeArea`](TypeAlias.RangeArea.md) | - | - | [src/types/interfaces.ts:914](https://github.com/revolist/revogrid/blob/a6a858841b6179f71d79deffde996e3ef6220356/src/types/interfaces.ts#L914) |
