[RevoGrid Documentation v4.26.0](README.md) / RangeClipboardPasteEvent
...
| `data` | \{\} | - | - | [src/types/interfaces.ts:915](https://github.com/revolist/revogrid/blob/ed4e703a0ef6a1db8113d868ffd81d53372a8861/src/types/interfaces.ts#L915) |
| `models` | \{\} | - | - | [src/types/interfaces.ts:916](https://github.com/revolist/revogrid/blob/ed4e703a0ef6a1db8113d868ffd81d53372a8861/src/types/interfaces.ts#L916) |
| `range` | `null` \| [`RangeArea`](TypeAlias.RangeArea.md) | - | - | [src/types/interfaces.ts:917](https://github.com/revolist/revogrid/blob/ed4e703a0ef6a1db8113d868ffd81d53372a8861/src/types/interfaces.ts#L917) |
