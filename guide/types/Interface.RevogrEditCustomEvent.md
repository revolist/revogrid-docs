[RevoGrid Documentation v4.20.2](README.md) / RevogrEditCustomEvent
...
| `target` | `public` | `HTMLRevogrEditElement` | Returns the object to which event is dispatched (its target). [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/target) | `CustomEvent.target` | - | [src/components.d.ts:821](https://github.com/revolist/revogrid/blob/71bd96b7ce813d8a294c3ab036825488de27ea6c/src/components.d.ts#L821) |
