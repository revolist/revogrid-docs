[RevoGrid Documentation v4.20.4](README.md) / RevogrFocusCustomEvent
...
| `target` | `public` | `HTMLRevogrFocusElement` | Returns the object to which event is dispatched (its target). [MDN Reference](https://developer.mozilla.org/docs/Web/API/Event/target) | `CustomEvent.target` | - | [src/components.d.ts:829](https://github.com/revolist/revogrid/blob/cfeb4fc76813e849e961384dd1448ab9e5490d6a/src/components.d.ts#L829) |
