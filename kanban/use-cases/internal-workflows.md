...
imageAlt: Real RevoGrid internal workflow Kanban with request, approval, and fulfillment cards
head:
  - - meta
    - name: keywords
...
<KanbanUseCaseMedia
  ...
  alt="Real RevoGrid internal workflow Kanban with request routing, approval decisions, values, owners, and deadlines"
