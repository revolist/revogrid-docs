...
imageAlt: Real RevoGrid Kanban manufacturing quality board with traceable inspection records
head:
  - - meta
    - name: keywords
...
<KanbanUseCaseMedia
  ...
  alt="Real RevoGrid Kanban quality board with work orders, lots, stations, inspection results, containment impact, and closure evidence"
