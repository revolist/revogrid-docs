...
imageAlt: Real RevoGrid product delivery Kanban with product and platform swimlanes
head:
  - - meta
    - name: keywords
...
<KanbanUseCaseMedia
  ...
  alt="Real RevoGrid product delivery Kanban with five workflow stages, two workstreams, release context, and a visible build WIP warning"
