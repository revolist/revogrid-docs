...
imageAlt: Real RevoGrid sales and onboarding Kanban with account-first opportunity cards
head:
  - - meta
    - name: keywords
...
<KanbanUseCaseMedia
  ...
  alt="Real RevoGrid sales and onboarding Kanban with account monograms, ARR, next customer actions, and go-live dates"
