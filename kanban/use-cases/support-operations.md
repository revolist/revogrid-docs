...
imageAlt: Real RevoGrid support Kanban with customer, SLA, queue, and ownership context
head:
  - - meta
    - name: keywords
...
<KanbanUseCaseMedia
  ...
  alt="Real RevoGrid support operations Kanban with five service stages, two teams, customer identity, SLA clocks, and an investigation WIP warning"
