...
const articleUrl = new URL('./workflow-columns.md', import.meta.url)
const referringPages = [
  new URL('./use-cases/sales-onboarding.md', import.meta.url),
  new URL('./use-cases/internal-workflows.md', import.meta.url),
]
