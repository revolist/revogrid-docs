const featuresProBase = [
    ...
    },
    {
        ...
        link: '/kanban',
        demoUrl: '/demo/kanban',
        description: 'Virtualized JavaScript Kanban board built on RevoGrid for product workflows, delivery planning, operations queues, and high-volume task management.',
        subFeatures: [
    ...
    },
    {
        ...
        subFeatures: [
            ...
            { title: 'Overlap, outside-availability, locked-change, duration, resource, and capacity conflicts' },
            { title: 'Resource grouping, unassigned work, coverage requirements, and utilization metrics' },
            { title: 'Event templates, recurring event helpers, recurrence series edits, and bulk actions' },
            { title: 'Custom event bars, headers, labels, tooltips, context menus, and keyboard shortcuts' },
            { title: 'Remote loading, optimistic mutations, validation, commit, refresh, and rollback hooks' },
            { title: 'Export helpers for events, visible schedules, resource workload, conflicts, and coverage' },
        ],
    },
    {
