const featuresProBase = [
  ...
  },
  {
    ...
    group: 'Grid Structure',
    description:
      'Automatically merges cells with identical values across columns. Supports group-aware merging with leading columns that act as visual anchors — perfect for hierarchical data, grouped rows, and report-style layouts. Hides duplicate values and borders while keeping the underlying data intact.',
  ...
  },
  {
    ...
    group: 'Grid Structure',
    description:
      'Column hiding is a feature that allows you to hide specific columns in your grid, making them invisible to users. This is useful for focusing on specific data points, reducing visual clutter, creating different views of the same dataset, and implementing column visibility toggles.',
  },
  {
    ...
    group: 'Grid Structure',
    description:
      'Drag and reorder entire column groups as a single unit. Keeps multilevel column headers intact while letting users rearrange grouped sections to match their preferred layout.',
  },
  {
  ...
  },
  {
    ...
    group: 'Data Filtering & Search',
    description: 'Slider filter, defining a range of values for filtering.',
  ...
  },
  {
    ...
    group: 'Data Visualization',
    description:
      'Build a grid inside a grid, showcasing advanced editing options and user interactions for a more dynamic data presentation.',
  ...
  },
  {
    ...
    group: 'Layout & Styling',
    description: 'Distinct styles to odd rows for improved readability and better data separation.',
  ...
  },
  {
    ...
    description:
      'Form editing directly within the grid, featuring all necessary fields, including custom options and markdown support for a fast and enhanced data entry experience.',
  ...
  },
  {
    ...
    group: 'Data Entry & Automation',
    description:
      'Interactive slider component for intuitive numeric value editing directly within grid cells, featuring customizable ranges and real-time visual feedback. Perfect for applications requiring precise numeric input control or when dealing with bounded numeric ranges.',
  ...
  },
  {
    ...
    group: 'Data Entry & Automation',
    description:
      'Elegant plus/minus counter interface for precise numeric value adjustments within grid cells, offering configurable step sizes and range limits. Ideal for applications requiring quick incremental changes or when dealing with bounded numeric values that need frequent small adjustments.',
  ...
  },
  {
    ...
    group: 'Data Entry & Automation',
    description:
      'Visual timeline editor featuring an intuitive progress bar and native date pickers for seamless date range selection within grid cells. Perfect for project management, scheduling, and any application requiring visual time tracking or date range manipulation.',
  ...
  },
  {
    ...
    demoUrl: '/demo/kanban',
    description:
      'RevoGrid Kanban is a virtualized JavaScript Kanban board component built on RevoGrid for product workflows, delivery planning, operations queues, and high-volume task management.',
    subFeatures: [
  ...
  },
  {
    ...
    group: 'Pro Advanced Modules',
    description:
      'Production-ready Gantt chart and scheduling view for project planning, dependency management, resource allocation, and timeline analysis.',
    subFeatures: [
      {
  ...
  },
  {
    ...
    description:
      'Commercial event scheduling for staff rosters, booking calendars, resource timelines, shift planning, availability rules, conflicts, remote data, and scheduler exports.',
    subFeatures: [
      { title: 'Day, week, month, and resource timeline views' },
      { title: 'Event side-channel props for controlled scheduler data' },
      { title: 'Resource, assignment, availability, template, and coverage datasets' },
      { title: 'Create, move, resize, edit, delete, select, copy, paste, and duplicate workflows' },
      { title: 'Cancelable mutation lifecycle and host-owned persistence' },
      { title: 'Calendars, working hours, blocked time, holidays, breaks, and availability rules' },
      {
        title:
          'Overlap, outside-availability, locked-change, duration, resource, and capacity conflicts',
      },
      {
        title: 'Resource grouping, unassigned work, coverage requirements, and utilization metrics',
      },
      {
        title:
          'Event templates, recurring event helpers, recurrence series edits, and bulk actions',
      },
      {
        title:
          'Custom event bars, headers, labels, tooltips, context menus, and keyboard shortcuts',
      },
      {
        title:
          'Remote loading, optimistic mutations, validation, commit, refresh, and rollback hooks',
      },
      {
        title:
          'Export helpers for events, visible schedules, resource workload, conflicts, and coverage',
      },
    ],
  },
  {
    ...
    group: 'Data Management',
    description:
      'Real-time multi-user editing that lets multiple people work on the same grid simultaneously. See live cursors and cell highlights for every connected user, track who is editing what, and commit changes through a shared conflict-resolution layer — so every participant always sees a consistent, up-to-date view of the data.',
  },
]
