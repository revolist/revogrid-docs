  ...
  <section id="catalog" class="section catalog-section">
    <div class="pro-container">
      ...
      <div class="feat-catalog">
        <div v-for="group in groups" :key="group.rawLabel" class="feat-section">
          <div class="feat-section-head">
            <span
              class="feat-section-icon"
              :style="groupIconStyle(group.rawLabel)"
              v-html="group.icon"
            />
...
const catalogTitleHighlight = computed(() =>
  String(props.page.catalog.title.highlight).replace(
    /\{categoryCount\}/g,
    String(props.categoryCount),
  ),
)
