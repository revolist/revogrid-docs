...
<template>
  <div class="features-container">
    <div
      v-for="(groupFeatures, groupName) in groupedFeatures"
      :key="groupName"
      class="feature-group"
    >
          ...
          <div class="card-inner">
            <div class="card-front">
              <div class="thumbnail-container">
                <img :src="feature.thumbnail" :alt="feature.title" class="thumbnail" />
              </div>
              <h3 class="title">
                {{ feature.title }} <Badge v-if="feature.beta" type="warning" text="BETA" />
              </h3>
            ...
            <span v-if="feature.videoUrl" class="plus-icon"><VPImage :image="'plus.svg'" /></span>
          </div>
        </div>
      </div>
    </div>
