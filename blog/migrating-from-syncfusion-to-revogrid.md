...
head:
  ...
  - - meta
    - property: og:url
      content: https://rv-grid.com/blog/migrating-from-syncfusion-to-revogrid
  - - meta
    - property: og:image
      content: https://rv-grid.com/blog/syncfusion.png
  - - meta
    - name: twitter:card
      content: summary_large_image
  - - link
    - rel: canonical
      href: https://rv-grid.com/blog/migrating-from-syncfusion-to-revogrid
  - - script
