...
const libraryPageSource = readFileSync(new URL('./GanttUseCasesPage.vue', import.meta.url), 'utf8')
const libraryRouteSource = readFileSync(new URL('./use-cases.md', import.meta.url), 'utf8')
...
test('keeps the shared Gantt article media component image-only', () => {
  const articleMediaSource = readFileSync(new URL('./GanttUseCaseMedia.vue', import.meta.url), 'utf8')
