...
import {
  ownerColumn,
  statusColumn,
} from '../../../../../../../../.vitepress/theme/home-v2/capabilities/shared/columns'
import {
  treeColumns,
  treeExample,
} from '../../../../../../../../.vitepress/theme/home-v2/capabilities/examples/tree/example'
...
describe('Tree data selection filters', () => {
  it('synchronizes Owner and Status options with their cell templates', () => {
    ...
    const ownerOption = owner?.cellTemplate?.(
      h as never,
      {
        value: 'maya chen',
        prop: 'owner',
    ...
    const statusOption = status?.cellTemplate?.(
      h as never,
      {
        value: 'on track',
        prop: 'health',
    ...
    ) as { data?: { style?: Record<string, string> }; children?: unknown }
    ...
    const growthCell = growth?.cellTemplate?.(
      h as never,
      {
        value: 12,
        prop: 'growth',
