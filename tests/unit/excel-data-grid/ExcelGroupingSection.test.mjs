...
const groupingSection = readFileSync(new URL('../../../excel-data-grid/ExcelGroupingSection.vue', import.meta.url), 'utf8')
const styles = readFileSync(new URL('../../../excel-data-grid/excelLanding.scss', import.meta.url), 'utf8')
