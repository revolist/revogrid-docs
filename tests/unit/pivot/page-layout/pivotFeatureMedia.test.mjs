...
const componentSource = readFileSync(new URL('../../../../pivot/page-layout/PivotFeaturesSection.vue', import.meta.url), 'utf8')
const heroSource = readFileSync(new URL('../../../../pivot/page-layout/PivotHeroSection.vue', import.meta.url), 'utf8')
const layoutSource = readFileSync(new URL('../../../../pivot/PivotPageLayout.vue', import.meta.url), 'utf8')
const stylesSource = readFileSync(new URL('../../../../pivot/page-layout/pivot-page-layout.scss', import.meta.url), 'utf8')
