...
Current coverage: [docs shell suite](../demo-experience.spec.ts) checks the canonical shell; it does not establish the workflow cases above. [Standalone gallery E2E](../../../../revogrid-demos/tests/e2e/gallery.spec.ts) covers Try example/Clear All but its 1,000-row total is stale. [Source tests](../../../../revogrid-demos/pro-filtering/tests/filtering.test.mjs) do not prove embedded interaction.
