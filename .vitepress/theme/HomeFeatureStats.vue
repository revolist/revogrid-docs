            ...
            <div class="cols">
                <div class="col" v-for="f in FEATURES" :key="f.title">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-label">{{ f.statLabel }}</span>
                    </div>
                    <div class="col-title">{{ f.title }}</div>
                    <div class="col-desc">{{ f.desc }}</div>
                    <div class="tags">
...
const FEATURES = [
    {
        ...
        tags: ['Virtual scroll', 'Lazy load', 'Web Workers', 'Batch render'],
    },
    {
        icon: '🧩',
        title: 'Deep Extensibility',
        desc: 'Custom column types, plugin API, custom editors, and cell renderers. Build any data experience without fighting the framework.',
        stat: '40+',
        statLabel: 'built-in column types',
        tags: ['Plugin API', 'Custom editors', 'Cell renderers', 'Hooks'],
    },
    {
        icon: '🔌',
