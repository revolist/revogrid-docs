...
.demo-nav{padding:16px 10px;background:color-mix(in srgb,var(--vp-c-bg-soft) 56%,var(--vp-c-bg));box-shadow:inset -1px 0 color-mix(in srgb,var(--vp-c-divider) 72%,transparent)}
.demo-nav header{height:32px;padding:0 8px 10px;font-size:14px;font-weight:600;letter-spacing:-.01em}
.demo-nav>label{position:relative;height:34px;padding:0 10px 0 30px;border-color:color-mix(in srgb,var(--vp-c-divider) 88%,transparent);background:var(--vp-c-bg);box-shadow:0 1px 2px rgb(15 23 42/3%)}
...
.demo-nav nav{height:calc(100% - 66px);padding-top:12px;scrollbar-width:thin}
