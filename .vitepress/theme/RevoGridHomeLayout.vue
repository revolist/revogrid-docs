<template>
  <main class="rg-home">
    ...
    <Content class="rg-home-formatted" />
  </main>
</template>
...
const data = computed<AnyRecord>(() => frontmatter.value as AnyRecord)
</script>
...
.rg-top-nav {
  ...
  top: 0;
  z-index: 100;
  background: color-mix(in srgb, var(--rg-bg) 86%, transparent);
...
.rg-code-panel {
  background: #19192b;
  color: #d6deff;
  border-color: rgba(25, 25, 43, 0.9);
  border-radius: 16px;
