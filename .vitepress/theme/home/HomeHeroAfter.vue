  ...
  <div class="VPFeatures VPHomeFeatures">
    <div class="container flex">
      <div class="VPFeature">
        ...
        <div class="rv-heading-2">In a few seconds.</div>
        <div class="details">
          With just a few lines of code, you can have a powerful data grid up and running. Simple
          API, intuitive configuration, and out of the box integration with your favorite framework
          - Vue, React, Angular, Svelte or vanilla JavaScript.
          <br /><br />
