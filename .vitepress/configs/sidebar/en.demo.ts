...
export const sidebarDemonEn: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        text: demoSidebarText('infinity-scroll', 'Server-side scrolling'),
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        items: [
          {
            text: demoSidebarText('pivot', 'Pivot table'),
            link: '/demo/pivot',
          },
        ],
      },
      {
        ...
        items: [
          {
            text: demoSidebarText('gantt', 'Gantt chart'),
            link: '/demo/gantt',
          },
          {
            text: demoSidebarText('gantt-big-data', '10K tasks'),
            link: '/demo/gantt-big-data',
          },
          {
            text: demoSidebarText('gantt-horizontal-big-data', '20-year timeline'),
      ...
      },
      {
        ...
        items: [
          {
            text: demoSidebarText('event-scheduler', 'Shift scheduling'),
      ...
      },
      {
        ...
        items: [
          {
            text: demoSidebarText('kanban', 'Task board'),
            link: '/demo/kanban',
          },
          {
            text: demoSidebarText('kanban-performance', '50K cards'),
            link: '/demo/kanban-performance',
          },
          {
            text: demoSidebarText('kanban-server-loading', 'Server loading'),
