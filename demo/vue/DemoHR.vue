    ...
    <div class="performance-metrics VPCard">
      ...
      <div class="VPCard__body">
        ...
        >
          <span
            >Render Time:
            <code>{{ renderTime ? `${renderTime.toFixed(2)} ms` : 'N/A' }}</code></span
          >
        </el-tooltip>
        <el-tooltip
          raw-content
        ...
        >
          <span>
            ...
            <span v-if="memoryUsage">
              <code
                >Used:
                {{ (memoryUsage.usedJSHeapSize / 1024 / 1024).toFixed(2) }}
                MB</code
              >
              <code
                >Total:
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          columnType: 'select',
          source: ['blue', 'green', 'brown', 'dimgrey', 'dodgerblue', 'deeppink', 'maroon'],
        },
      ] as ColumnRegular[],
    },
    {
